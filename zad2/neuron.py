...
class Neuron:
    def __init__(self, input: np.ndarray[float] = None, weights: np.ndarray[float] = None,  activation_function: Callable = None, traning_step: float = 0.5, amount_weights_and_neurons = 6):
